                    ...
                    <div class="col-sm-12">
                        <div class="card mb-0">
                            <div class="card-header">
                                ...
                                @endif
                                <h3 class="card-text d-inline-block"> Post Table - <span class="badge badge-success">10</span> </h3>
                                 </div>
                            <div class="card-body">
                                        ...
                                        @foreach($posts as $post)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form id="deleteFrom{{$comment->id}}" action="{{route('author.comment.destroy',$comment->id)}}" method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </td>
