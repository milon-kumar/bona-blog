...
class PostController extends Controller
{
    ...
    {
        return view('Backend.admin.post.show',[
            'post'=>$post,
        ]);
    }
    ...
    public function update(Request $request, Post $post)
    {
        ...
        return redirect()->route('admin.post.index')->with('success','Your Post Updated Successfully');
    }
    ...
    public function destroy(Post $post)
    {
        @unlink($post->image);
        $post->delete();
        return redirect()->route('admin.post.index')->with('success','Your Post Deleted Successfully');
    }
}
